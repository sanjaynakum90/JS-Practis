            ...
            newsContainer.innerHTML = `
                        <div class="col-12">
                            <div class="alert alert-info text-center" role="alert">
                                ...
                                No news found for "${category}". Try another category.
                            </div>
                        </div>`;
        ...
        data.articles.forEach(article => {
            ...
            col.innerHTML = `
                        <div class="card h-100">
                            <img src="${article.urlToImage || 'https://via.placeholder.com/300x200/6c757d/ffffff?text=No+Image'}" 
                                 class="card-img-top" alt="${article.title || 'News Image'}">
                            <div class="card-body">
